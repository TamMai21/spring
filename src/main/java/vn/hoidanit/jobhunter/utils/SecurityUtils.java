...
public class SecurityUtils {
    ...
    @Value("${me.jwt.access-token-validity-in-seconds}")
    ...
    public String createAccessToken(String email, ResLoginDTO.UserLogin resLoginDTO) {
        ...
        // hardcode permission (test thu)
        List<String> listAuthority = List.of("ROLE_USER_CREATE", "ROLE_USER_UPDATE");
